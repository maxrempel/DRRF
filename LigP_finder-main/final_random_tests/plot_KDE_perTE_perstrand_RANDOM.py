...
### Load all datasets
df1 = pd.read_csv("dataset1_RANDOM_all_chromosomes_exbor1.tsv", sep="\t")
df2 = pd.read_csv("dataset1_RANDOM_all_chromosomes_exbor2.tsv", sep="\t")
df3 = pd.read_csv("dataset2_RANDOM_all_chromosomes_exbor1.tsv", sep="\t")
df4 = pd.read_csv("dataset2_RANDOM_all_chromosomes_exbor2.tsv", sep="\t")
...
##################
    ...
    plt.xlabel('Exbor')
    plt.ylabel('Density')
    plt.title(f'{TE_family} KDE RANDOM: Merged datasets, all chr, both exbors: bw_adjust=0.1')
    plt.grid(True)
    ...
    plt.savefig(f"KDE_RANDOM_{out_TE_family}_plot.png", dpi=300, bbox_inches='tight')
    plt.close()
